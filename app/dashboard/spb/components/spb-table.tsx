...
import { SPB, createColumns } from "./spb-table-columns";
import { SPBFilterDialog } from "./spb-filter-dialog";
...
export function SPBTable({ data, pageCount, totalItems }: SPBTableProps) {
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 items-center space-x-2">
          <div className="relative w-full max-w-sm">
            ...
            <Input
              placeholder="Cari nomor SPB atau pemohon..."
