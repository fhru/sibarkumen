...
interface SPPBFilterDialogProps {
...
export function SPPBFilterDialog({
  statusValue,
  isPrintedValue,
  startDate,
  endDate,
  onApplyFilters,
}: SPPBFilterDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-xl max-w-2xl overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Filter Data SPPB</DialogTitle>
          <DialogDescription>
            Pilih filter untuk menyaring data SPPB sesuai kebutuhan Anda.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-6 py-4">
          ...
          {/* Status Filter */}
          <div className="space-y-2">
            <Label htmlFor="status">Status SPPB</Label>
            <Select
            ...
            >
              ...
              <SelectContent className="w-full">
                ...
                <SelectItem value="MENUNGGU_BAST">Menunggu BAST</SelectItem>
