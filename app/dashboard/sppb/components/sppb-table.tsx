...
import { SPPB, createColumns } from "./sppb-table-columns";
import { SPPBFilterDialog } from "./sppb-filter-dialog";

interface SPPBTableProps {
  data: SPPB[];
  pageCount: number;
  totalItems: number;
}

export function SPPBTable({ data, pageCount, totalItems }: SPPBTableProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 items-center space-x-2">
          ...
          {(currentStatus || currentIsPrinted || startDate || endDate) && (
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9"
