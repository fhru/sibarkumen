...
import { z } from 'zod';
import { createPihakKetiga } from '@/drizzle/actions/pihak-ketiga';
...
export function PihakKetigaDialogCreate() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button>
          <Plus className="mr-2 h-4 w-4" /> Tambah Pihak Ketiga
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Masukkan nama pihak ketiga yang baru.
          </DialogDescription>
        </DialogHeader>
