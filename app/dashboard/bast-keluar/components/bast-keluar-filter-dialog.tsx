...
interface BastKeluarFilterDialogProps {
...
export function BastKeluarFilterDialog({
  isPrintedValue,
  startDate,
  endDate,
  onApplyFilters,
}: BastKeluarFilterDialogProps) {
  ...
  const hasActiveFilters = isPrintedValue || startDate || endDate;
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-xl max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Filter Data BAST Keluar</DialogTitle>
          <DialogDescription>
            Pilih filter untuk menyaring data BAST Keluar sesuai kebutuhan Anda.
          </DialogDescription>
        </DialogHeader>
