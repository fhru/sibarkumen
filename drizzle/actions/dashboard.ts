...
import { getMutasiBarangList } from './mutasi-barang';
...
export async function fetchLowStockItems(limit = 5) {
...
export async function fetchFastMovingItems(limit = 5) {
...
export async function fetchDeadStockItems(limit = 5) {
